...
library(scDNA)
<<<<<<< Updated upstream
file<-system.file("Data","PS90-037_6.dna+protein.h5",package="scdnadata")
...
hg19refseq_txdb<-loadDb("./data/hg19refseq_txdb.sqlite")
banned <-read.csv("./data/banned_list.csv")[,1]
=======
annotation_key<-read.csv(system.file("data","annotation_key.csv",package="scDNA"))
hg19refseq_txdb<-loadDb(system.file("data","hg19refseq_txdb.sqlite",package="scDNA"))
banned<-read.csv(system.file("data","banned_list.csv",package="scDNA"))[,1]
...
<<<<<<< Updated upstream
write.FCS(ff,"~/Desktop/1962_perfect.fcs")
=======
