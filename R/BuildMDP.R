...
#' @param use_ADO a flag to consider ADO connections/actions within the MDP (default is FALSE)
#' @param cores Number of parallel workers to use. Default is 1.Show more lines
#'
#' @examples
#' \dontrun{
#' adj_list <- BuildMDP(num_mutations = 4,use_ADO=F)
#' }
BuildMDP <-function(num_mutations,use_ADO=FALSE,cores=1){
